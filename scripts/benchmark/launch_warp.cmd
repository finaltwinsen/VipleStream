...
echo [launch_warp] env  = NO_MV=%VIPLE_VKFRUC_WARP_NO_MV% QUALITY=%VIPLE_VKFRUC_WARP_QUALITY% PURE50=%VIPLE_VKFRUC_WARP_PURE50% REAL_USE_CRGB=%VIPLE_VKFRUC_REAL_USE_CRGB% TRIPLE=%VIPLE_VKFRUC_TRIPLE%
