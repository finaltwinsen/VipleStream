...
echo [launch_warp] env  = NO_MV=%VIPLE_VKFRUC_WARP_NO_MV% QUALITY=%VIPLE_VKFRUC_WARP_QUALITY% PURE50=%VIPLE_VKFRUC_WARP_PURE50% REAL_USE_CRGB=%VIPLE_VKFRUC_REAL_USE_CRGB%

temp\moonlight\VipleStream.exe stream 192.168.51.226 Desktop ^
    --1080 --fps 60 --video-codec H.264 --frame-interpolation --no-yuv444
