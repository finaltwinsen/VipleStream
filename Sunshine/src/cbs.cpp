 ...
 */
// Define FFmpeg config macros needed by get_bits.h before including FFmpeg headers.
// We only define what MSVC needs; avoid HAVE_INLINE_ASM which enables GCC-only asm.
#ifdef _MSC_VER
...
#  endif
// Pre-include Windows/D3D11 headers with C++ linkage before FFmpeg pulls them in
// inside extern "C", which would cause operator== overload conflicts in d3d11.h.
#  include <windows.h>
#  include <d3d11.h>
#  include <dxgi.h>
#endif
