...
// Define the undocumented COM interface GUIDs. On MSVC, DEFINE_GUID requires INITGUID
// to be defined in exactly one TU (audio.cpp does this) to produce the definition.
