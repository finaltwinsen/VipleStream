...
private:
    ...
    // §J.3.e.2.i.17 (v1.4.82) — Backward ME pipeline + buffers + descsets for
    // bidirectional Phase A. Reuses median pipeline for bwd MV smoothing.
    ...
    // §J.3.e.2.i.17 (v1.4.82) — Backward MV buffers.
