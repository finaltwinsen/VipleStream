...
#define SER_ENABLEMPQUIC "enablempquic"
#define SER_MPQUICSCHEDULER "mpquicscheduler"
...
void StreamingPreferences::reload()
{
    ...
    enableMpQuic = settings.value(SER_ENABLEMPQUIC, false).toBool();
    mpQuicScheduler = settings.value(SER_MPQUICSCHEDULER, 0).toInt();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_ENABLEMPQUIC, enableMpQuic);
    settings.setValue(SER_MPQUICSCHEDULER, mpQuicScheduler);
