...
public class NvHTTP {
    ...
    public ComputerDetails getComputerDetails(String serverInfo) throws IOException, XmlPullParserException {
        ...
        // VipleStream: parse STUN/NAT traversal info from serverinfo
        details.stunNatType = getXmlString(serverInfo, "StunNatType", false);
        String stunEp = getXmlString(serverInfo, "StunEndpoint", false);
        if (stunEp != null && stunEp.contains(":")) {
